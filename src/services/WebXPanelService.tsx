...
const WebXPanelService: React.FC = () => {
  useEffect(() => {
    ...
    /* --------------------------------------------------------------------------------------------------------------------- */
    WebXPanelConfigParams.host = entries.host ?? 'YOUR VC4 INSTANCE HERE'; // Should be reverted to windows.location.hostname once installed on processor
    ...
    /* --------------------------------------------------------------------------------------------------------------------- */
    WebXPanelConfigParams.authToken = entries.authToken ?? 'YOUR TOKEN HERE';
